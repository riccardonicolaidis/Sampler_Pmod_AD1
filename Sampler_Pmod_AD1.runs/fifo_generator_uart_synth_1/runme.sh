...
HD_PWD='C:/Users/rikir/Documents/FPGA_projects/Sampler_Pmod_AD1/Sampler_Pmod_AD1.runs/fifo_generator_uart_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_generator_uart.tcl
