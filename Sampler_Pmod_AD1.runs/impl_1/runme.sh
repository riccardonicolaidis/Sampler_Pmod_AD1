...
HD_PWD='C:/Users/rikir/Documents/FPGA_projects/Sampler_Pmod_AD1/Sampler_Pmod_AD1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sampler_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sampler_top_module.tcl -notrace
