...
HD_PWD='C:/Users/rikir/Documents/FPGA_projects/Sampler_Pmod_AD1/Sampler_Pmod_AD1.runs/XADC_only_for_template_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_only_for_template.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XADC_only_for_template.tcl
