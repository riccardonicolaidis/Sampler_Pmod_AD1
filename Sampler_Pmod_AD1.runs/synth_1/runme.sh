...
HD_PWD='C:/Users/rikir/Documents/FPGA_projects/Sampler_Pmod_AD1/Sampler_Pmod_AD1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sampler_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sampler_top_module.tcl
