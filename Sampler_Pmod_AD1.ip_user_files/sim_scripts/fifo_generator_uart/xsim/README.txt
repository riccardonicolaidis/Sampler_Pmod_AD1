...
#
# Generated by export_simulation on Fri Apr 01 11:48:35 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_generator_uart.sh' script.

./fifo_generator_uart.sh -reset_run
...
./fifo_generator_uart.sh -noclean_files

For more information on the script, please type './fifo_generator_uart.sh -help'.
